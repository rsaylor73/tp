...
$time = array($months,$days,$hours,$mins,$secs);
$palign = array('   MONTH',' DAYS',' HOURS','MINS','SEC');
...
//print "<meta content=\"Content-Type: image/png\">";
//print "<meta content=\"Content-Disposition: inline; filename=\"picture.png\"";
//$g->Stroke();

...
class Tickets {
	...
	public function search() {
        ...
        public function get_settings() {
                ...
                $siteurl = "http://www.ticketpointe.com/";
                //$site_email = "tickets@ticketpointe.com";
		$site_email = "admin@ticketpointe.com";

                $base_path = "/home/tpapp";
		$server_ip = "98.142.222.98";
		$domain_user = "tpapp";
		$domain_pw = "c9brobra";
		$domain = "ticketpointe.com";
	...
	public function free() {
		...
		if ($_POST['token'] != $_SESSION['token']) {
			...
			die;
                        ...
                        $msg = "$_POST[name],<br><br>Thank you for ordering your tickets from Ticketpointe. Please check your email for your tickets. If the email is not delivered please check your spam folder.<br>$html";

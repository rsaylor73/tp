                        ...
                        <tr>
                                <td width="600" valign=top>
                                        <table border=0 width=100%>
                                                <tr><td><img src="uploads/<?=$row['userID']?>/cover/<?=$row['id']?>/<?=$row['cover_image']?>" width="600"></td></tr>
                                                <tr><td>
                                                ...
                                                <tr><td><a href="mailto:<?=$row['email'];?>&subject=<?=$row['title'];?>"><span class="btn btn-primary">Contact Organizer</span></a></td></tr>
                                        </table>
                                ...
                                <td width="800" valign=top>
                                        <table border=0 width=100%>
                                                <tr><td colspan=2></td><center><h1><?=$row['title']?></h1></center><center><h2><?=$row['tagline']?></h2></center></tr>
                                                <tr><td colspan=2>
                                                        <center>
      ...
      setInterval(refreshDiv, 1000);
								...
								if ($qty_used >= $total_avail) {
									print "<tr><td colspan=3><font color=red>Sorry, <b>$row2[name]</b> is sold out.</font></td></tr>";
                                                        ...
                                                        <td valign=top><input type="button" class="btn btn-default" value="Add To Calendar"
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;<input type="button" class="btn btn-default" value="Share With Friends" onclick="window.location.href='mailto:?subject=Tickete Pointe&body=Hi please visit <?=$url;?>';"> <?=$page_views;?> views<br><br>
                                                        <?php
...
<div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;">
        ...
        <span data-u="arrowright" class="jssora02r" style="top:123px;right:8px;width:55px;height:55px;" data-autocenter="2"></span>
                                                ...
                                                if ($row['video'] != "") {
                                                ?>
                                                <tr><td colspan=2 align=center><?=$row['video'];?></td></tr>
                                                <?php
                                                }
                                                ?>
                                        </table>
